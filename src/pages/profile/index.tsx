          ...
          <CardBody>
            ...
            <div>
              ...
              <div className="font-bold">
                ...
                branch first, pull latest from main branch then checkout from
                main branch to create your pull request. never checkout from
                your pull request.
              </div>
              <li>
                I will review your pull request, then merge it to main branch.
                this rule will apply to me too, i will also create a pull
                request first too before i merge it to main branch. good luck!
              </li>
            </div>
          </CardBody>
          <Divider />
